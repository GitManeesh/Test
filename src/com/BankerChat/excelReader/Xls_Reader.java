...
/* // to run this on stand alone
 public static void main(String arg[]) throws IOException{
  ...
  Xls_Reader datatable = null;
    ...
    int col =0;
    for(int row =1;row<datatable.getRowCount("Login");row++){
    	for(col=1;col<datatable.getColumnCount("Login");col++){
         System.out.println(datatable.getCellData("Login", col,row+1));
